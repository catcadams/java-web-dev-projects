...
public class Case {
    ...
    public Case(){
        ...
        Topping topping1 = new Topping("Sprinkles", .10, new ArrayList<>(Arrays.asList("none")));
        Topping topping2 = new Topping("Cookie Dough", .50, new ArrayList<>(Arrays.asList("gluten, dairy")));
        Topping topping3 = new Topping("Chocolate Sauce", .25, new ArrayList<>(Arrays.asList("none")));
        Topping topping4 = new Topping("Granola", .25, new ArrayList<>(Arrays.asList("gluten")));
        Topping topping5 = new Topping("Andes Mints", .75, new ArrayList<>(Arrays.asList("dairy")));
